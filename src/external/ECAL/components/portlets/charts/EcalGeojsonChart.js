...
import { geojson } from '../../geojson/ecal';
...
class EcalGeojsonChart extends Component {

    constructor(props) {
        super(props);
        this.chart = null;
        this.id = generateId('ecalGeojsonChart');
    }
...
export default sizeMe({ monitorWidth: true })(
    connect(mapStateToProps, mapDispatchToProps)(EcalGeojsonChart)
);
